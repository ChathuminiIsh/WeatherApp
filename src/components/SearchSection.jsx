...
const SearchSection = ({getWeatherDetails, searchInputRef}) => {
    ...
    const handleCitySearch = (e) => {
        ...
        const API_URL =` http://api.weatherapi.com/v1/forecast.json?key=${API_KEY}&q=${searchInput.value}&days=6`;
    ...
    const handleLocationSearch =() =>{
        navigator.geolocation.getCurrentPosition(
            (position) =>{
                ...
                const API_URL =` http://api.weatherapi.com/v1/forecast.json?key=${API_KEY}&q=${latitude},${longitude}&days=6`;
        getWeatherDetails(API_URL);
